# This script will alias the eth0 on the Raspberry Pi s so they can 
...
ifconfig eth0:0 10.36.68.30 netmask 255.255.255.0 broadcast 10.36.68.255

printf "This Raspberry PI belongs to The Trobots !!\n\n" > /etc/motd
